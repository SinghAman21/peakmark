...
import { X, Copy, Check, Download, Image, Code } from "lucide-react";
...
export const BadgeEditor = ({
  ...
  const updateField = <K extends keyof Badge>(field: K, value: Badge[K]) => {
    ...
    if (
      field === "icon" &&
      value &&
      (editedBadge.iconPosition === undefined || editedBadge.iconPosition < 0)
    ) {
      ...
      >
        <div className="w-full max-w-6xl max-h-[90vh] overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-h-[calc(90vh-60px)] overflow-y-auto items-start">
            ...
            >
              <h2 className="font-mono font-semibold text-lg mb-6">
                Customize Badge
              </h2>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value: Badge["style"] | null) =>
                      setEditedBadge(
                        applyStylePreset(editedBadge, value ?? "flat"),
                      )
                    }
                  >
